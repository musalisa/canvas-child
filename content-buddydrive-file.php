<div>content-buddydrive-file.php</div>
<?php
/**
...
?>
	...
	<div class="fix"></div>
<?php
//echo do_shortcode( '[zoomsounds_player source="http://wpdev.sva.net/wp-content/uploads/2015/01/aetherphon.mp3" config="default" playerid="38" waveformbg="" waveformprog="" thumb="" autoplay="on" cue="on" enable_likes="off" enable_views="off" songname="aetherphon" artistname=""]');
